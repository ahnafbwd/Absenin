...
int yMouse;
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnsignup, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 440, 160, 30));
        ...
        getContentPane().add(btnlogin, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 370, 180, 40));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/LOGIN DOSEN.png"))); // NOI18N
    ...
    private void btnloginMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnloginMouseClicked
        ...
        try {
            String sql = "SELECT * FROM dosen WHERE username='"+txtusername.getText()+"'AND password='"+txtpassword.getText()+"'";
    ...
    private void btnsignupMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnsignupMouseClicked
        // TODO add your handling code here:
        registerDosen regDosen = new registerDosen();
        regDosen.setVisible(true);
        regDosen.pack();
        regDosen.setLocationRelativeTo(null);
        regDosen.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.dispose();
