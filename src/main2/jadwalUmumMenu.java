 ...
 * @author USER
 */
public class jadwalUmumMenu extends javax.swing.JFrame {
int xMouse;
int yMouse;
    /**
     * Creates new form dashboardDosenMenu
     */
    public jadwalUmumMenu() {
        initComponents();
        refresh();
...
private void ambilData() {
    ...
    private void initComponents() {
        ...
        table_jadwal.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_ALL_COLUMNS);
        table_jadwal.setColumnSelectionAllowed(true);
        table_jadwal.setGridColor(new java.awt.Color(255, 255, 255));
        table_jadwal.setOpaque(false);
        table_jadwal.setSelectionBackground(new java.awt.Color(153, 255, 255));
        table_jadwal.setSelectionForeground(new java.awt.Color(153, 153, 153));
    ...
    private void btnDashboardDosenMenuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDashboardDosenMenuMouseClicked
        // TODO add your handling code here:
        jadwalUmumMenu dshDosen = new jadwalUmumMenu();
    ...
    private void btnCariMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnCariMouseClicked
        ...
        try{
            Statement statement = (Statement) koneksi.getConnection().createStatement();
            ResultSet res = statement.executeQuery("Select * from jadwal where "
                + "dosen like'%" + txtCari.getText() + "%'OR mata_kuliah like'%" + txtCari.getText() + "%' OR ruang like'%" + txtCari.getText() + "%' OR hari like'%" + txtCari.getText() + "%'");
            DefaultTableModel tbl = new DefaultTableModel();
            tbl.addColumn("NO");
            tbl.addColumn("ID JADWAL");
            tbl.addColumn("DOSEN");
    ...
    private void btnPengaturanDatabaseMahasiswaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnPengaturanDatabaseMahasiswaMouseClicked
        // TODO add your handling code here:
        databaseJadwalUmum databaseMahasiswa = new databaseJadwalUmum();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jadwalUmumMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new jadwalUmumMenu().setVisible(true);
            }
        });
    }
