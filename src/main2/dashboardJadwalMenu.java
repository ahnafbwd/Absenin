 ...
 * @author USER
 */
public class dashboardJadwalMenu extends javax.swing.JFrame {
int xMouse;
int yMouse;
    /**
     * Creates new form dashboardPerkuliahanMenu
     */
    public dashboardJadwalMenu() {
        initComponents();
...
void showDate(){
 ...
 void showTime(){
    ...
    private void initComponents() {
        ...
        btnjadwalpengganti = new javax.swing.JLabel();
        btnjampelajaran = new javax.swing.JLabel();
        btnJadwalumum = new javax.swing.JLabel();
        ...
        btnjadwalpengganti.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        btnjadwalpengganti.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        btnjadwalpengganti.setText("JADWAL PENGGANTI");
        btnjadwalpengganti.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnjadwalpengganti.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btnjadwalpenggantiMouseClicked(evt);
            }
        });
        getContentPane().add(btnjadwalpengganti, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 420, 260, 90));

        btnjampelajaran.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        btnjampelajaran.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        btnjampelajaran.setText("JAM PELAJARAN");
        btnjampelajaran.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnjampelajaran.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btnjampelajaranMouseClicked(evt);
            }
        });
        getContentPane().add(btnjampelajaran, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 414, 260, 90));

        btnJadwalumum.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        btnJadwalumum.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        btnJadwalumum.setText("JADWAL");
        btnJadwalumum.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnJadwalumum.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btnJadwalumumMouseClicked(evt);
            }
        });
        getContentPane().add(btnJadwalumum, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 220, 250, 80));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/_DASHBOARD JADWAL.png"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));

        pack();
    }// </editor-fold>//GEN-END:initComponents

    private void btnjadwalpenggantiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnjadwalpenggantiMouseClicked
        // TODO add your handling code here:
        jadwalPenggantiMenu dshlain = new jadwalPenggantiMenu();
        dshlain.setVisible(true);
        dshlain.pack();
        dshlain.setLocationRelativeTo(null);
        dshlain.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.dispose();
    }//GEN-LAST:event_btnjadwalpenggantiMouseClicked

    private void btnjampelajaranMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnjampelajaranMouseClicked
        // TODO add your handling code here:
        dashboardjampelajaranmenu dshpre = new dashboardjampelajaranmenu();
        dshpre.setVisible(true);
        dshpre.pack();
        dshpre.setLocationRelativeTo(null);
        dshpre.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.dispose();
    }//GEN-LAST:event_btnjampelajaranMouseClicked

    private void btnJadwalumumMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnJadwalumumMouseClicked
        // TODO add your handling code here:
        jadwalUmumMenu dshjad = new jadwalUmumMenu();
        dshjad.setVisible(true);
        dshjad.pack();
        dshjad.setLocationRelativeTo(null);
        dshjad.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.dispose();
    }//GEN-LAST:event_btnJadwalumumMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dashboardJadwalMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new dashboardJadwalMenu().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel btnJadwalumum;
    private javax.swing.JLabel btnjadwalpengganti;
    private javax.swing.JLabel btnjampelajaran;
