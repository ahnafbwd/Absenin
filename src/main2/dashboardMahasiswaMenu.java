 ...
 * @author USER
 */
public class dashboardMahasiswaMenu extends javax.swing.JFrame {
int xMouse;
int yMouse;
    /**
     * Creates new form dashboardMahasiswaMenu
     */
    public dashboardMahasiswaMenu() {
        initComponents();
        refresh();
    ...
    private void btnPengaturanDatabaseMahasiswaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnPengaturanDatabaseMahasiswaMouseClicked
        // TODO add your handling code here:
        databaseMahasiswaMenu databaseMahasiswa = new databaseMahasiswaMenu();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dashboardMahasiswaMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new dashboardMahasiswaMenu().setVisible(true);
            }
        });
    }
