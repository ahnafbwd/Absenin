 ...
 * @author USER
 */
public class databaseJurusan extends javax.swing.JFrame {
int xMouse;
int yMouse;
    /**
     * Creates new form databaseDosen
     */
    public databaseJurusan() {
        initComponents();
...
private void ambilData() {
    ...
    private void initComponents() {
        ...
        txtidjurusan.setBackground(new java.awt.Color(166, 166, 166));
        txtidjurusan.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        txtidjurusan.setForeground(new java.awt.Color(255, 255, 255));
        txtidjurusan.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtidjurusan.setBorder(null);
        getContentPane().add(txtidjurusan, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 340, 220, 20));

        txtjurusan.setBackground(new java.awt.Color(166, 166, 166));
        txtjurusan.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        getContentPane().add(txtjurusan, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 340, 230, 20));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/DATABASE JURUSAN.png"))); // NOI18N
    ...
    private void table_jurusanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table_jurusanMouseClicked
        ...
        String id_jurusan = (String) table_jurusan.getValueAt(i, 1);
        txtidjurusan.setText(id_jurusan);
        String jurusan = (String) table_jurusan.getValueAt(i, 2);
    ...
    private void btnCreateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnCreateMouseClicked
        // TODO add your handling code here:
        if(txtidjurusan.getText().equals("")){
            ...
            try{
                Statement statement = (Statement) koneksi.getConnection().createStatement();
                statement.executeUpdate("insert into jurusan VALUES (null,'" + jurusan +"')");
                statement.close();
    ...
    private void btnDeleteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDeleteMouseClicked
        ...
        if(txtidjurusan.getText().equals("")){
            ...
            String id = txtidjurusan.getText();

            try{
                Statement statement = (Statement) koneksi.getConnection().createStatement();
                statement.executeUpdate("delete from jurusan where id_jurusan = '" + id + "'");
    ...
    private void btnUpdateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnUpdateMouseClicked
        ...
        if(txtidjurusan.getText().equals("")){
            ...
            try{
                Statement statement = (Statement) koneksi.getConnection().createStatement();
                statement.executeUpdate("update jurusan SET id_jurusan='"+id_jurusan+"'," + "jurusan='"+jurusan+"'");
                statement.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(databaseJurusan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new databaseJurusan().setVisible(true);
            }
        });
    }
