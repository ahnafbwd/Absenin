 ...
 * @author USER
 */
public class dashboardRuangMenu extends javax.swing.JFrame {
int xMouse;
int yMouse;
    /**
     * Creates new form dashboardDosenMenu
     */
    public dashboardRuangMenu() {
        initComponents();
        refresh();
...
private void ambilData() {
    ...
    private void initComponents() {
        ...
        table_ruang = new javax.swing.JTable();
        ...
        table_ruang.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        table_ruang.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_ALL_COLUMNS);
        table_ruang.setColumnSelectionAllowed(true);
        table_ruang.setGridColor(new java.awt.Color(255, 255, 255));
        table_ruang.setOpaque(false);
        table_ruang.setSelectionBackground(new java.awt.Color(153, 255, 255));
        table_ruang.setSelectionForeground(new java.awt.Color(153, 153, 153));
        table_ruang.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                table_ruangMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(table_ruang);
    ...
    private void btnDashboardDosenMenuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDashboardDosenMenuMouseClicked
        // TODO add your handling code here:
        dashboardRuangMenu dshDosen = new dashboardRuangMenu();
    ...
    private void btnCariMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnCariMouseClicked
        ...
        try{
            Statement statement = (Statement) koneksi.getConnection().createStatement();
            ResultSet res = statement.executeQuery("Select * from ruang where "
                + "id_ruanga like'%" + txtCari.getText() + "%'OR ruang like'%" + txtCari.getText() + "%'");
            DefaultTableModel tbl = new DefaultTableModel();
            tbl.addColumn("NO");
            tbl.addColumn("ID RUANG");
            tbl.addColumn("RUANG");
    ...
    private void btnPengaturanDatabaseMahasiswaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnPengaturanDatabaseMahasiswaMouseClicked
        // TODO add your handling code here:
        databaseRuang databaseMahasiswa = new databaseRuang();
    ...
    private void table_ruangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table_ruangMouseClicked
        int i = table_ruang.getSelectedRow();
        if (i == -1){
            return;
        }
        String id_ruang = (String) table_ruang.getValueAt(i, 1);
        txtCari.setText(id_ruang);
        String ruang = (String) table_ruang.getValueAt(i, 2);
        txtCari.setText(ruang);
    }//GEN-LAST:event_table_ruangMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dashboardRuangMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new dashboardRuangMenu().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable table_ruang;
