 ...
 * @author USER
 */
public class dashboardProgramStudiMenu extends javax.swing.JFrame {
int xMouse;
int yMouse;
    /**
     * Creates new form dashboardDosenMenu
     */
    public dashboardProgramStudiMenu() {
        initComponents();
        refresh();
...
private void ambilData() {
    ...
    private void initComponents() {
        ...
        table_programstudi.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_ALL_COLUMNS);
        table_programstudi.setColumnSelectionAllowed(true);
        table_programstudi.setGridColor(new java.awt.Color(255, 255, 255));
        table_programstudi.setOpaque(false);
        table_programstudi.setSelectionBackground(new java.awt.Color(153, 255, 255));
        table_programstudi.setSelectionForeground(new java.awt.Color(153, 153, 153));
    ...
    private void btnDashboardDosenMenuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDashboardDosenMenuMouseClicked
        // TODO add your handling code here:
        dashboardProgramStudiMenu dshDosen = new dashboardProgramStudiMenu();
    ...
    private void btnCariMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnCariMouseClicked
        ...
        try{
            Statement statement = (Statement) koneksi.getConnection().createStatement();
            ResultSet res = statement.executeQuery("Select * from program_studi where "
                + "id_program_studi like'%" + txtCari.getText() + "%'OR program_studi like'%" + txtCari.getText() + "%' OR nama like'%" + txtCari.getText() + "%'");
            DefaultTableModel tbl = new DefaultTableModel();
            tbl.addColumn("NO");
            tbl.addColumn("ID PROGRAM STUDI");
            tbl.addColumn("PROGRAM STUDI");
    ...
    private void btnPengaturanDatabaseMahasiswaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnPengaturanDatabaseMahasiswaMouseClicked
        // TODO add your handling code here:
        databaseProgramStudi databaseMahasiswa = new databaseProgramStudi();
    ...
    private void table_programstudiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table_programstudiMouseClicked
        ...
        txtCari.setText(id_program_studi);
        String program_studi = (String) table_programstudi.getValueAt(i, 2);
        txtCari.setText(program_studi);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dashboardProgramStudiMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new dashboardProgramStudiMenu().setVisible(true);
            }
        });
    }
