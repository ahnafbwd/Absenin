 ...
 * @author USER
 */
public class dashboardAdminMenu extends javax.swing.JFrame {
int xMouse;
int yMouse;
    /**
     * Creates new form dashboardDosenMenu
     */
    public dashboardAdminMenu() {
        initComponents();
        refresh();
...
private void ambilData() {
    ...
    private void initComponents() {
        ...
        table_admin.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_ALL_COLUMNS);
        table_admin.setColumnSelectionAllowed(true);
        table_admin.setGridColor(new java.awt.Color(255, 255, 255));
        table_admin.setOpaque(false);
        table_admin.setSelectionBackground(new java.awt.Color(153, 255, 255));
        table_admin.setSelectionForeground(new java.awt.Color(153, 153, 153));
    ...
    private void btnDashboardDosenMenuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDashboardDosenMenuMouseClicked
        // TODO add your handling code here:
        dashboardAdminMenu dshDosen = new dashboardAdminMenu();
    ...
    private void btnPengaturanDatabaseMahasiswaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnPengaturanDatabaseMahasiswaMouseClicked
        ...
        databaseAdmin.setVisible(true);
        databaseAdmin.pack();
        databaseAdmin.setLocationRelativeTo(null);
        databaseAdmin.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dashboardAdminMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new dashboardAdminMenu().setVisible(true);
            }
        });
    }
