 ...
 * @author USER
 */
public class dashboardJurusanMenu extends javax.swing.JFrame {
int xMouse;
int yMouse;
    /**
     * Creates new form dashboardDosenMenu
     */
    public dashboardJurusanMenu() {
        initComponents();
        refresh();
...
private void ambilData() {
    ...
    private void initComponents() {
        ...
        table_jurusan.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_ALL_COLUMNS);
        table_jurusan.setColumnSelectionAllowed(true);
        table_jurusan.setGridColor(new java.awt.Color(255, 255, 255));
        table_jurusan.setOpaque(false);
        table_jurusan.setSelectionBackground(new java.awt.Color(153, 255, 255));
        table_jurusan.setSelectionForeground(new java.awt.Color(153, 153, 153));
    ...
    private void btnDashboardDosenMenuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDashboardDosenMenuMouseClicked
        // TODO add your handling code here:
        dashboardJurusanMenu dshDosen = new dashboardJurusanMenu();
    ...
    private void btnCariMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnCariMouseClicked
        ...
        try{
            Statement statement = (Statement) koneksi.getConnection().createStatement();
            ResultSet res = statement.executeQuery("Select * from jurusan where "
                + "id_jurusan like'%" + txtCari.getText() + "%'OR jurusan like'%" + txtCari.getText() + "%' ");
            DefaultTableModel tbl = new DefaultTableModel();
            tbl.addColumn("NO");
            tbl.addColumn("ID JURUSAN");
            tbl.addColumn("JURUSAN");
    ...
    private void btnPengaturanDatabaseMahasiswaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnPengaturanDatabaseMahasiswaMouseClicked
        // TODO add your handling code here:
        databaseJurusan databaseMahasiswa = new databaseJurusan();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dashboardJurusanMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new dashboardJurusanMenu().setVisible(true);
            }
        });
    }
