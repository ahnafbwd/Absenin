...
private void ambilData() {
    ...
    private void initComponents() {
        ...
        txtketerangan.setBackground(new java.awt.Color(166, 166, 166));
        ...
        getContentPane().add(txtketerangan, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 540, 300, 20));

        cmbstatus.setBackground(new java.awt.Color(236, 236, 236));
        cmbstatus.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Hadir", "Absen", "Ijin", "Sakit" }));
        cmbstatus.setBorder(null);
        getContentPane().add(cmbstatus, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 470, 260, 30));
        getContentPane().add(jDateChooser1, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 340, 260, 30));

        txtnim.setBackground(new java.awt.Color(166, 166, 166));
        ...
        getContentPane().add(txtnim, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 470, 210, 30));
        ...
        cmbnama.setBackground(new java.awt.Color(236, 236, 236));
        cmbnama.setBorder(null);
        getContentPane().add(cmbnama, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 400, 260, 30));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/database presensi.png"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));
        getContentPane().add(txtid, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 290, 50, 20));
        getContentPane().add(txtnamamahasiswa, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 530, -1, -1));
    ...
    private void btnCreateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnCreateMouseClicked
        ...
        if(!txtid.getText().equals("")){
            ...
            String id_presensi = txtid.getText();
            ...
            try{
                Statement statement = (Statement) koneksi.getConnection().createStatement();
                statement.executeUpdate("insert into presensi VALUES (null, '" + id_jadwal + "','"
                    + nama +"','"+ nim +"','"+ status +"','"+ tanggal +"','"+ keterangan +"','"+ id_jam_pelajaran +"')");
                statement.close();
    ...
    private void btnDeleteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDeleteMouseClicked
        ...
        if(txtid.getText().equals("")){
            ...
            try{
                Statement statement = (Statement) koneksi.getConnection().createStatement();
                statement.executeUpdate("delete from presensi where id_presensi = '" + id + "'");
    ...
    private void btnUpdateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnUpdateMouseClicked
        ...
        if(txtid.getText().equals("")){
            ...
            try{
                Statement statement = (Statement) koneksi.getConnection().createStatement();
                statement.executeUpdate("update presensi SET id_jadwal='"+id_jadwal+"'," + "nama='"+nama+"',"
                    + "nim='"+nim+"',"
                    + "status='"+status+"',"
                    + "tanggal='"+tanggal+"',"
