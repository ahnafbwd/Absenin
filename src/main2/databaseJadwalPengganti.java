 ...
 * @author USER
 */
public class databaseJadwalPengganti extends javax.swing.JFrame {
int xMouse;
int yMouse;
    /**
     * Creates new form databaseDosen
     */
    public databaseJadwalPengganti() {
        initComponents();
...
private void ambilData() {
        ...
        tbl.addColumn("NO");
        tbl.addColumn("ID PENGGANTI");
        tbl.addColumn("ID JADWAL");
        tbl.addColumn("TANGGAL");
        tbl.addColumn("RUANG");
        tbl.addColumn("ID JAM PELAJARAN");
        table_pengganti.setModel(tbl);
        try{
            Statement statement = (Statement) koneksi.getConnection().createStatement();
            ResultSet res = statement.executeQuery("Select * from pengganti");
            int index = 1;
            while (res.next())
            {
                tbl.addRow(new Object []{
                    index,
                    res.getString("id_pengganti"),
    ...
    {
        txtid.setText("");
        cmbidjadwal.setSelectedItem("");
        
        cmbruang.setSelectedItem("");
        cmbidjampelajaran.setSelectedItem("");
    ...
    public void tampil_combo_id_jam_pelajaran(){
       try{
           ...
           while(res.next()){
               cmbidjampelajaran.addItem(res.getString("id_jam_pelajaran"));
    ...
    private void initComponents() {
        ...
        cmbidjampelajaran = new javax.swing.JComboBox<>();
        jScrollPane1 = new javax.swing.JScrollPane();
        table_pengganti = new javax.swing.JTable();
        ...
        getContentPane().add(jDateChooser1, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 340, 260, 30));

        cmbidjadwal.setBackground(new java.awt.Color(236, 236, 236));
        cmbidjadwal.setBorder(null);
        getContentPane().add(cmbidjadwal, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 340, 260, 30));
        ...
        cmbruang.setBackground(new java.awt.Color(236, 236, 236));
        cmbruang.setBorder(null);
        getContentPane().add(cmbruang, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 400, 260, 30));

        cmbidjampelajaran.setBackground(new java.awt.Color(236, 236, 236));
        cmbidjampelajaran.setBorder(null);
        getContentPane().add(cmbidjampelajaran, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 400, 260, 30));

        table_pengganti.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        table_pengganti.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                table_penggantiMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(table_pengganti);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/database pengganti.png"))); // NOI18N
    ...
    private void table_penggantiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table_penggantiMouseClicked
        // TODO add your handling code here:
        int i = table_pengganti.getSelectedRow();
        if (i == -1){
            return;
        }
        String id_pengganti = (String) table_pengganti.getValueAt(i, 1);
        txtid.setText(id_pengganti);
        String id_jadwal = (String) table_pengganti.getValueAt(i, 2);
        cmbidjadwal.setSelectedItem(id_jadwal);
        String tanggal = (String) table_pengganti.getValueAt(i, 3);
        jDateChooser1.setDateFormatString(tanggal);
        String ruang = (String) table_pengganti.getValueAt(i, 4);
        cmbruang.setSelectedItem(ruang);
        String id_jam_pelajaran = (String) table_pengganti.getValueAt(i, 5);
        cmbidjampelajaran.setSelectedItem(id_jam_pelajaran);
    }//GEN-LAST:event_table_penggantiMouseClicked
    ...
    private void btnCreateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnCreateMouseClicked
        ...
        if(jDateChooser1.getDateFormatString().equals("")){
            ...
            String id_pengganti = txtid.getText();
            String id_jadwal =(String) cmbidjadwal.getSelectedItem();
            SimpleDateFormat dateformat = new SimpleDateFormat("yyyy-MM-dd");
            String tanggal =dateformat.format(jDateChooser1.getDate());
            String ruang = (String) cmbruang.getSelectedItem();
            String id_jam_pelajaran = (String) cmbidjampelajaran.getSelectedItem();

            try{
                Statement statement = (Statement) koneksi.getConnection().createStatement();
                statement.executeUpdate("insert into pengganti VALUES (null, '" + id_jadwal + "','"
                    + tanggal +"','"+ ruang +"','"+ id_jam_pelajaran +"')");
                statement.close();
    ...
    private void btnDeleteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDeleteMouseClicked
        ...
        if(txtid.getText().equals("")){
            ...
            try{
                Statement statement = (Statement) koneksi.getConnection().createStatement();
                statement.executeUpdate("delete from pengganti where id_pengganti = '" + id + "'");
    ...
    private void btnUpdateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnUpdateMouseClicked
        ...
        if(txtid.getText().equals("")){
            ...
            try{
                Statement statement = (Statement) koneksi.getConnection().createStatement();
                statement.executeUpdate("update pengganti SET id_jadwal='"+id_jadwal+"'," + "tanggal='"+tanggal+"',"
                    + "ruang='"+ruang+"',"
                    +"id_jam_pelajaran='"+id_jam_pelajaran+"',"
                    + "WHERE id_pengganti = '"+id_pengganti+"'");
                statement.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(databaseJadwalPengganti.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new databaseJadwalPengganti().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JComboBox<String> cmbidjampelajaran;
    ...
    private javax.swing.JTable table_pengganti;
