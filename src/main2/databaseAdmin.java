 ...
 * @author USER
 */
public class databaseAdmin extends javax.swing.JFrame {
int xMouse;
int yMouse;
    /**
...
private void ambilData() {
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtusername, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 340, 220, 20));
        ...
        getContentPane().add(txtpassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 340, 220, 20));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/DATABASE ADMIN menu.png"))); // NOI18N
    ...
    private void table_adminMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table_adminMouseClicked
        ...
        String username = (String) table_admin.getValueAt(i, 1);
        txtusername.setText(username);
        String password = (String) table_admin.getValueAt(i, 2);
    ...
    private void btnCreateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnCreateMouseClicked
        ...
        if(txtusername.getText().equals("")){
            ...
            try{
                Statement statement = (Statement) koneksi.getConnection().createStatement();
                statement.executeUpdate("insert into admin VALUES ('"+ username +"','"+ password +"')");
                statement.close();
    ...
    private void btnDeleteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDeleteMouseClicked
        ...
        if(txtusername.getText().equals("")){
            ...
            try{
                Statement statement = (Statement) koneksi.getConnection().createStatement();
                statement.executeUpdate("delete from admin where username = '" + username + "'");
    ...
    private void btnUpdateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnUpdateMouseClicked
        ...
        if(txtusername.getText().equals("")){
            ...
            try{
                Statement statement = (Statement) koneksi.getConnection().createStatement();
                statement.executeUpdate("update admin SET username='"+username+"',"       
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(databaseAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new databaseAdmin().setVisible(true);
            }
        });
    }
