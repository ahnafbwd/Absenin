 ...
 * @author USER
 */
public class databaseProgramStudi extends javax.swing.JFrame {
int xMouse;
int yMouse;
    /**
     * Creates new form databaseDosen
     */
    public databaseProgramStudi() {
        initComponents();
...
private void ambilData() {
        ...
        tbl.addColumn("NO");
        tbl.addColumn("ID PROGRAM STUDI");
        tbl.addColumn("PROGRAM STUDI");
        table_programstudi.setModel(tbl);
        try{
            ...
            while (res.next())
            {
                tbl.addRow(new Object []{
                    index,
                    res.getString("id_program_studi"),
    ...
    {
        txtidprogramstudi.setText("");
        txtprogramstudi.setText("");
        txtidprogramstudi.requestFocus();
    ...
    private void initComponents() {
        ...
        txtidprogramstudi = new javax.swing.JTextField();
        txtprogramstudi = new javax.swing.JTextField();
        jScrollPane1 = new javax.swing.JScrollPane();
        table_programstudi = new javax.swing.JTable();
        ...
        txtidprogramstudi.setBackground(new java.awt.Color(166, 166, 166));
        txtidprogramstudi.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        txtidprogramstudi.setForeground(new java.awt.Color(255, 255, 255));
        txtidprogramstudi.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtidprogramstudi.setBorder(null);
        getContentPane().add(txtidprogramstudi, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 340, 220, 20));

        txtprogramstudi.setBackground(new java.awt.Color(166, 166, 166));
        txtprogramstudi.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        txtprogramstudi.setForeground(new java.awt.Color(255, 255, 255));
        txtprogramstudi.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtprogramstudi.setBorder(null);
        getContentPane().add(txtprogramstudi, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 340, 220, 20));

        table_programstudi.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        table_programstudi.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                table_programstudiMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(table_programstudi);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/DATABASE program studi.png"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));

        pack();
    }// </editor-fold>//GEN-END:initComponents

    private void table_programstudiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table_programstudiMouseClicked
        // TODO add your handling code here:
        int i = table_programstudi.getSelectedRow();
        if (i == -1){
            return;
        }
        String id_program_studi = (String) table_programstudi.getValueAt(i, 1);
        txtidprogramstudi.setText(id_program_studi);
        String program_studi = (String) table_programstudi.getValueAt(i, 2);
        txtprogramstudi.setText(program_studi);
        
    }//GEN-LAST:event_table_programstudiMouseClicked
    ...
    private void btnCreateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnCreateMouseClicked
        // TODO add your handling code here:
        if(txtidprogramstudi.getText().equals("")){
            JOptionPane.showMessageDialog(null,
                "Silahkan refresh terlebih dahulu!");
        }
        else{
            String id_program_studi = txtidprogramstudi.getText();
            String program_studi = txtprogramstudi.getText();
            
            try{
                Statement statement = (Statement) koneksi.getConnection().createStatement();
                statement.executeUpdate("insert into program_studi VALUES (null, '" + program_studi + "')");
                statement.close();
    ...
    private void btnDeleteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDeleteMouseClicked
        ...
        if(txtidprogramstudi.getText().equals("")){
            ...
            String id = txtidprogramstudi.getText();

            try{
                Statement statement = (Statement) koneksi.getConnection().createStatement();
                statement.executeUpdate("delete from program_studi where id_program_studi = '" + id + "'");
    ...
    private void btnUpdateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnUpdateMouseClicked
        ...
        if(txtidprogramstudi.getText().equals("")){
            ...
            try{
                Statement statement = (Statement) koneksi.getConnection().createStatement();
                statement.executeUpdate("update program_studi SET program_studi='"+program_studi+"' WHERE id_program_studi = '"+id_program_studi+"'");
                statement.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(databaseProgramStudi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new databaseProgramStudi().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable table_programstudi;
    private javax.swing.JTextField txtidprogramstudi;
