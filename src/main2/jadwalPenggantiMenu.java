 ...
 * @author USER
 */
public class jadwalPenggantiMenu extends javax.swing.JFrame {
int xMouse;
int yMouse;
    /**
     * Creates new form dashboardDosenMenu
     */
    public jadwalPenggantiMenu() {
        initComponents();
        refresh();
...
private void ambilData() {
    ...
    private void btnDashboardDosenMenuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDashboardDosenMenuMouseClicked
        // TODO add your handling code here:
        jadwalPenggantiMenu dshDosen = new jadwalPenggantiMenu();
    ...
    private void btnCariMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnCariMouseClicked
        ...
        try{
            Statement statement = (Statement) koneksi.getConnection().createStatement();
            ResultSet res = statement.executeQuery("Select * from pengganti where "
                + "id_jadwal like'%" + txtCari.getText() + "%'OR tanggal like'%" + txtCari.getText() + "%' OR ruang like'%" + txtCari.getText() + "%'");
            DefaultTableModel tbl = new DefaultTableModel();
            tbl.addColumn("NO");
        tbl.addColumn("ID PENGGANTI");
        tbl.addColumn("ID JADWAL");
    ...
    private void btnPengaturanDatabaseMahasiswaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnPengaturanDatabaseMahasiswaMouseClicked
        // TODO add your handling code here:
        databaseJadwalPengganti databasejadwalpengganti = new databaseJadwalPengganti();
        databasejadwalpengganti.setVisible(true);
        databasejadwalpengganti.pack();
        databasejadwalpengganti.setLocationRelativeTo(null);
        databasejadwalpengganti.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.dispose();
    ...
    private void table_mahasiswaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table_mahasiswaMouseClicked
        ...
        txtCari.setText(id);
        String id_jadwal = (String) table_mahasiswa.getValueAt(i, 2);
        txtCari.setText(id_jadwal);
        String tanggal = (String) table_mahasiswa.getValueAt(i, 3);
        txtCari.setText(tanggal);
        String ruang = (String) table_mahasiswa.getValueAt(i, 4);
        txtCari.setText(ruang);
        String id_jam_pelajaran = (String) table_mahasiswa.getValueAt(i, 5);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jadwalPenggantiMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new jadwalPenggantiMenu().setVisible(true);
            }
        });
    }
